...
Sign Up
      ...
      Already have an accout? <a wire:click.prevent="registration" class="text-blue-500 cursor-pointer"> Sign In </a>
      </div>
      </div>
</div>
...
>
  Sign In
        ...
        <div class="m-5 text-sm">
        Don't have an accout? <a wire:click.prevent="registration" class="text-blue-500 cursor-pointer"> Sign Up </a>
        </div>
        </div>
</div>
@endif
