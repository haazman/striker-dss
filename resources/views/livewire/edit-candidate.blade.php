    ...
    <div class="m-10 flex flex-col shadow-lg rounded-lg bg-slate-white border items-center gap-4 p-6">
        <h3 class="block font-sans text-4xl font-light leading-snug tracking-normal text-black antialiased">
          ...
          <div class="flex flex-col items-center justify-center">
           <input type="file" wire:model.defer='filepath' accept="image/png, image/jpeg, image/jpg" class="hidden" id="photo">
           <label for="photo">
            @if($first == 1)
              <img src="{{asset('storage/'.$alternatif->image_path)}}" class="relative inline-block h-36 w-36 rounded-full object-cover object-center"
             alt="Image placeholder">
            @else
            @if($success == 1)
             <img src="{{asset($photoPath)}}" class="relative inline-block h-36 w-36 rounded-full object-cover object-center"
             alt="Image placeholder">
             @else
             <img src="{{asset('storage/candidate/default.jpg')}}" class="relative inline-block h-36 w-36 rounded-full object-cover object-center"
             alt="Image placeholder">
             @endif
             @endif
           </label>
           @error('filepath') <span class="text-red-700">{{ $message }}</span>   @enderror
      ...
      @error('alternatif.name') <span class="text-red-700">{{ $message }}</span>@enderror
      ...
      @error('alternatif.stamina') <span class="text-red-700">{{ $message }}</span>@enderror
      ...
      @error('alternatif.posture') <span class="text-red-700">{{ $message }}</span>@enderror
      <div class="relative h-11 w-1/3 min-w-[200px]">
      ...
      @error('alternatif.finishing') <span class="text-red-700">{{ $message }}</span>@enderror
      ...
      @error('alternatif.dribbling') <span class="text-red-700">{{ $message }}</span>@enderror
      <div class="relative h-11 w-full min-w-[200px]">
      ...
      @error('alternatif.header') <span class="text-red-700">{{ $message }}</span>@enderror
      <div class="relative h-11 w-full min-w-[200px]">
      ...
      @error('alternatif.attitude') <span class="text-red-700">{{ $message }}</span>@enderror
    </div>
    <div class="w-full">
      <button wire:click.prevent="updateCandidate"
