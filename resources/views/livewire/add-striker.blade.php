           ...
           Add Team
                  ...
                  <div class="relative mb-5 h-11 w-11/12 min-w-[200px]">
                    <input type="text" wire:model="searchTeam"
                       class="peer h-full w-full rounded-lg border border-black border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-gray-400 placeholder-shown:border-t-blue-gray-400 focus:border-2 focus:border-blue-700 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
            ...
            <div class="shadow-md border bg-white w-full rounded-lg">
              ...
              <div class="flex flex-col gap-10 justify-center items-center mt-10 mb-5">
                <div class="relative h-10 w-11/12 min-w-[200px]">
                  <select wire:model="team_id" class="peer h-full w-full rounded-[7px] border border-gray-400 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-700 placeholder-shown:border-t-blue-700 empty:!bg-red-700 focus:border-2 focus:border-blue-700 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50">
                    <option>...</option>
