    ...
    <div class="flex w-full flex-col items-center justify-center m-10">
        <div class="w-full md:w-4/5">
            <div class="relative right-0 w-full">
                <ul wire:ignore class="relative flex list-none flex-wrap rounded-xl bg-slate-400 p-1" data-tabs="tabs"
                    role="list">
                        ...
                        <div class="flex flex-col w-full items-center justify-center">
                            <div class="shadow-md border bg-white w-full md:w-full rounded-lg">
                                ...
                                <div class="flex flex-col m-10 items-center justify-center">
                                    ...
                                    <table
                                        class="w-full rounded-lg border text-center border-none shadow-lg bg-slate-50">
                                        <tr>
                                            <td> No. </td>
                                            <td> Name </td>
                                            ...
                                            <tr class="bg-white rounded-lg" wire:key="team-{{ $team->id }}">
                                                ...
                                                <td class="font-light">
                                                    <div class="flex flex-row justify-center gap-3">
                                                        <button wire:key="showTeam-{{ $team->id }}"> <i
                                                                class="material-icons"> visibility </i> </button>
                                                        <button wire:key="editTeam-{{ $team->id }}"> <i
                                                                class="material-icons"> edit </i> </button>
                                                        <button
                                                            onclick="confirm('Are you sure you want to delete this team?')"
                                ...
                                <div class="flex flex-col gap-10 justify-center items-center m-5">
                                    <div class="relative h-10 w-full min-w-[200px]">
                                        <select wire:model="team_id"
                                            class="peer h-full w-full rounded-[7px] border border-black border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-black placeholder-shown:border-t-blue-gray-200 empty:!bg-red-700 focus:border-2 focus:border-blue-700 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50">
                                            <option>...</option>
                                            @foreach ($teams as $team)
                                    ...
                                    <tr class="bg-white rounded-lg">
                                        ...
                                        <td class="font-light">
                                            <div class="flex flex-row justify-center gap-3">
                                                ...
                                                <button
                                                    onclick="confirm('Are you sure you want to delete this candidate?')"
                                                    wire:click.prevent="deleteCandidateId({{ $alternatifs->id }})"> <i
                                                        class="material-icons"> delete </i> </button>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <!-- Delete Modal -->
            <div>
                <div data-dialog-backdrop="dialog" wire:ignore.self data-dialog-close="true"
                    class="pointer-events-none fixed inset-0 z-[999] grid h-screen w-screen place-items-center bg-black bg-opacity-60 opacity-0 backdrop-blur-sm transition-opacity duration-300">
                    <div data-dialog="dialog" wire:ignore.self
                        ...
                        <div class="flex shrink-0 flex-wrap items-center justify-end p-4 text-blue-gray-500">
                            ...
                            <button wire:click.prevent="delete" data-ripple-light="true" data-dialog-close="true"
