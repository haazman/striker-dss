              ...
              <div class="shadow-md border bg-white w-full md:w-full rounded-lg">
                  ...
                  <div class="flex flex-col gap-10 justify-center items-center m-5">
                    <div class="relative h-11 w-full min-w-[200px]">
                      <input type="text" wire:model.defer="team_name"
            ...
            <div class="shadow-md border bg-white w-full rounded-lg">
              ...
              <div class="flex flex-col gap-10 justify-center items-center m-5">
                <div class="relative h-10 w-full min-w-[200px]">
                  <select wire:model="team_id" class="peer h-full w-full rounded-[7px] border border-black border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-black placeholder-shown:border-t-blue-gray-200 empty:!bg-red-500 focus:border-2 focus:border-blue-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50">
                    <option>...</option>
                    @foreach($teams as $team)
